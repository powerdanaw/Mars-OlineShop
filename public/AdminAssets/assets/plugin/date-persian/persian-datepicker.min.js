...
$(function () {
  $('#datepicker-multiple-date').persianDatepicker({
...
// $(function () {
//   $('#example-date-input').persianDatepicker({
...
// 
$(function () {
    $('#datepicker-autoclose').persianDatepicker({
  ...
  $(function () {
    $('#form-datepicker').persianDatepicker({
