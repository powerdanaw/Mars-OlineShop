...
$(function() {
    ...
    $(document).ready(function() {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['فرو','ارد','خرد','تیر','مرد','شهر','مهر','ابان','اذر','دی','بهمن','اسف'],
            },
            legend: {
    ...
    $(document).ready(function() {
        var options = {
            ...
            xaxis: {
                categories: ['جمعه', 'پنج', 'چهار', 'سه شنبه', 'دوشنبه', 'یکشنبه', 'شنبه'],
            }
        };
    ...
    $(document).ready(function() {
        var options = {
            series: [{
                name: 'هزینه ها',
                data: [113100, 118000, 111400, 110900, 111200, 101600, 131700, 121300, 101400, 119900, 125100]
            }],
            chart: {
                height: 315,
                type: 'bar',
            ...
            xaxis: {
                categories: ["فرو", "ارد", "خرد", "تیر", "مرد", "شهر", "مهر", "ابان", "اذر", "دی", "بهمن"],
                position: 'bottom',
                axisBorder: {
                    show: false
                },
