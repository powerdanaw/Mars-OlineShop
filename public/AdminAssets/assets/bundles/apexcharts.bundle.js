! function (t, e) {
    ...
    var X = {
            name: "en",
            options: {
                months: ["فروردین", "اردیبهش", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"],
                shortMonths: ["فرو", "ارد", "خرد", "تیر", "مرد", "شهر", "مهر", "ابان", "اذر", "دی", "بهمن", "اسف"],
                days: ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنجشنبه", "جمعه"],
                shortDays: ["جمعه", "پنج", "چهار", "سه", "دو", "یکشنبه", "شنبه"],
                toolbar: {
            ...
            value: function () {
                return {
                    ...
                    chart: {
                        ...
                        foreColor: "#373d3f",
                        fontFamily: "iran, Helvetica, Arial, sans-serif",
                        height: "auto",
                    ...
                    tooltip: {
                        ...
                        custom: function (t) {
                            var e = t.seriesIndex,
                                i = t.dataPointIndex,
                                t = t.w;
                            return a._getBoxTooltip(t, e, i, ["باز", "بالا", "", "کم", "بستن"], "candlestick")
                        }
                    },
                    states: {
                        active: {
                    ...
                    tooltip: {
                        ...
                        custom: function (t) {
                            var e = t.seriesIndex,
                                i = t.dataPointIndex,
                                t = t.w;
                            return a._getBoxTooltip(t, e, i, ["مینیمم", "ک1", "مدیان", "ک3", "مکسیمم"], "پلات")
                        }
                    },
                    markers: {
                        size: 5,
        ...
        Z = (o(ve, [{
            ...
            value: function (t) {
                ...
                for (var n, l = 0; l < t.length; l++) {
                    ...
                    }), s.series.push(n)), s.seriesZ.push(this.threeDSeries), void 0 !== t[l].name ? s.seriesNames.push(t[l].name) : s.seriesNames.push("سری-" + parseInt(l + 1, 10)), void 0 !== t[l].color ? s.seriesColors.push(t[l].color) : s.seriesColors.push(void 0)
                }
                return this.w
            }
        }, {
